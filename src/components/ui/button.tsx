  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border-2 border-border bg-card hover:bg-secondary hover:text-secondary-foreground  hover:shadow-md",
        ...
        warning: "bg-background text-warning border-2 border-warning hover:bg-warning/10 shadow-sm hover:shadow-md",
        accent: "bg-accent text-accent-foreground hover:bg-accent/90 shadow-md hover:shadow-lg transition-all duration-200",
        pos: "bg-gradient-to-r from-primary to-primary-hover text-primary-foreground hover:shadow-xl hover:scale-105 transition-all duration-300",
        ...
        "pos-success": "bg-gradient-to-r from-success to-success-light text-success-foreground hover:shadow-sm hover:scale-105 transition-all duration-300 ",
      },
      size: {
